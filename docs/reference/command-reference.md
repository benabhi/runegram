---
titulo: "Referencia Completa de Comandos"
...
documentos_relacionados:
  ...
  - "../getting-started/player-guide.md"
referencias_codigo:
  - "commands/player/"
  - "commands/admin/"
estado: "actual"
...
### Para Jugadores
- [Guía de Jugador](../getting-started/player-guide.md) - Tutorial básico
- [Filosofía del Proyecto](../getting-started/core-philosophy.md) - Cómo funciona el juego

### Para Desarrolladores
- [Creando Comandos](../content-creation/creating-commands.md) - Guía para crear nuevos comandos
...
- [Creando Contenido](../content-creation/) - Cómo crear salas, items, etc.
