...
Ver: [Sistema de Permisos](../sistemas-del-motor/sistema-de-permisos.md)

---

## Documentos Disponibles

### 1. [Comandos de Administración](comandos-de-administracion.md)
...
### 2. [Migraciones de Base de Datos](migraciones-de-base-de-datos.md)
...
1. **Primero**: Lee [Comandos de Administración](comandos-de-administracion.md)
2. **Segundo**: Prueba comandos básicos en entorno de desarrollo
3. **Tercero**: Familiarízate con [Sistema de Permisos](../sistemas-del-motor/sistema-de-permisos.md)
4. **Cuarto**: Explora [Creación de Contenido](../creacion-de-contenido/README.md) para expandir el mundo

### Para Administradores de Sistema

Si gestionas la infraestructura:

1. Lee [Migraciones de Base de Datos](migraciones-de-base-de-datos.md)
2. Revisa [Configuración del Sistema](../arquitectura/configuracion.md)
3. Familiarízate con [Configuración del Sistema](../arquitectura/configuracion.md)
...
Ver: [Creación de Contenido](../creacion-de-contenido/README.md)
...
Ver: [Migraciones de Base de Datos](migraciones-de-base-de-datos.md)
...
Ver: [Configuración del Sistema](../arquitectura/configuracion.md)
...
Ver: [Sistema de Comandos](../sistemas-del-motor/sistema-de-comandos.md)

---

## Próximos Pasos

1. **Aprende comandos básicos**: Lee [Comandos de Administración](comandos-de-administracion.md)
2. **Familiarízate con la arquitectura**: Revisa [Configuración del Sistema](../arquitectura/configuracion.md)
3. **Practica en desarrollo**: Usa Docker Compose localmente
4. **Expande el mundo**: Aprende [Creación de Contenido](../creacion-de-contenido/README.md)
5. **Gestiona la BD**: Domina [Migraciones de Base de Datos](migraciones-de-base-de-datos.md)
